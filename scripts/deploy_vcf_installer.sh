...
OVFTOOL="E:\Offline-Depot-9.1.0.0\PROD\COMP\VCENTER\VMware-VCSA-all-9.1.0.0.25370922\vcsa\ovftool\win32\ovftool.exe"
VCF_INSTALLER_OVA="E:\Offline-Depot-9.1.0.0\PROD\COMP\SDDC_MANAGER_VCF\VCF-SDDC-Manager-Appliance-9.1.0.0.25371088.ova"
...
VCF_INSTALLER_VMNAME=vcf9-sddcm01
VCF_INSTALLER_HOSTNAME=vcf9-sddcm01.abidi.systems
VCF_INSTALLER_IP=172.30.0.12
VCF_INSTALLER_SUBNET=255.255.255.0
VCF_INSTALLER_GATEWAY=172.30.0.253
VCF_INSTALLER_DNS_SERVER=192.168.1.100
VCF_INSTALLER_DNS_DOMAIN=abidi.systems
VCF_INSTALLER_DNS_SEARCH=abidi.systems
VCF_INSTALLER_NTP=192.168.1.100
